...
const DELETE_JOKE_NAMES = {
  "delete-monday": "周一暂停供应",
  "delete-group": "社交电量已清空",
  "delete-boss": "老板勿扰特调",
  "delete-todos": "待办暂存酒",
...
const RECIPES = [
  {
    ...
    allergens: ["可能含乳制品"],
    ingredients: [
      ["黄酒", "400ml 45ml / 600ml 65ml"],
      ["橙汁", "400ml 70ml / 600ml 105ml"],
      ["元气森林葡萄汽水", "400ml 90ml / 600ml 135ml"],
      ["冰块", "适量"],
    ],
  ...
  },
  {
    ...
    allergens: [],
    ingredients: [
      ["黄酒", "400ml 40ml / 600ml 60ml"],
      ["乌龙茶", "400ml 150ml / 600ml 230ml"],
      ["水溶C", "400ml 40ml / 600ml 60ml"],
      ["冰块", "适量"],
    ],
  ...
  },
  {
    id: "R03",
    name: "一蓑烟雨",
    note: "青柠、蜂蜜、薄荷与苏打水的轻盈酸甜",
    personalities: { reflection: 1, adventure: 0.25, comfort: 0.2 },
    tastes: { tea: 1, refreshing: 0.92, sweet: 0.18 },
    blockedBy: ["citrus"],
    allergens: [],
    ingredients: [
      ["福建老酒", "400ml 65ml / 600ml 100ml"],
      ["青柠汁", "400ml 20ml / 600ml 30ml"],
      ["蜂蜜糖浆", "400ml 13ml / 600ml 20ml"],
      ["苏打水", "400ml 130ml / 600ml 200ml"],
      ["薄荷叶", "5~6片（拍醒）"],
      ["冰块", "适量"],
    ],
    glass: { color: "#d5a65f", sparkling: false },
    method: "摇壶中混合老酒、青柠汁、蜂蜜糖浆、薄荷叶加冰摇匀，过滤入加满新冰的杯中，最后补满苏打水。",
  ...
  },
  {
    ...
    allergens: [],
    ingredients: [
      ["黄酒", "400ml 43ml / 600ml 67ml"],
      ["葡萄汁（浓稠型）", "400ml 87ml / 600ml 133ml"],
      ["乳酸菌（养乐多类）", "400ml 130ml / 600ml 200ml"],
      ["冰块", "适量"],
    ],
  ...
  },
  {
    ...
    allergens: ["可能含乳制品"],
    ingredients: [
      ["葡萄汁", "400ml 37ml / 600ml 57ml"],
      ["芬达（橙味）", "400ml 74ml / 600ml 114ml"],
      ["雪碧（柠檬味）", "400ml 111ml / 600ml 171ml"],
      ["黄酒", "400ml 37ml / 600ml 57ml"],
      ["冰块", "适量"],
    ],
  ...
  },
  {
    ...
    allergens: ["可能含乳制品"],
    ingredients: [
      ["养乐多", "400ml 100ml / 600ml 150ml"],
      ["橙汁", "400ml 100ml / 600ml 150ml"],
      ["黄酒", "400ml 67ml / 600ml 100ml"],
      ["冰块", "加满"],
    ],
    method: "摇壶加冰，将所有材料充分摇匀约15秒，过滤倒入加满新冰的杯中。",
    glass: { color: "#f2bd83", sparkling: false },
    names: ["快乐加载99%", "理智暂不供应", "请重新生成快乐"],
  },
];
